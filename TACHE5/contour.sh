...
# Il calcul ensuite ses contours et les met dans un fichier suffixé par .contour
...
nom_doss_cont=$1_CONTOUR_MULTIPLE
...
then
    ...
    mv $1/*contour.txt $nom_doss_cont
fi
