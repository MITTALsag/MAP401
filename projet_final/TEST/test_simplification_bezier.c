...
** Puis il va simplifier ce contour grace au courbe de bezier de degres 2
...
int main(int argc, char* argv[])
{
    ...
    strcat(nom_fichier_sortie, "contour_bezier_simple.txt");

    simplification_bezier2(nom_fichier_entree, nom_fichier_sortie, (float) atof(argv[2]));
    ...
    cree_image_eps_bezier2(nom_fichier_sortie, largeur_image(I), hauteur_image(I), nom_fichier_eps_simple, 'F');
}
