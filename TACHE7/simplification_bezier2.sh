...
contour_simpl=$1_CONTOUR_SIMPLE
eps_comp=$1_FILL_EPS_COMPLET
eps_simpl=$1_FILL_EPS_SIMPLE
...
do
    ...
    ./TEST/test_simplification_bezier $file $2
...
then
    ...
    mv $1/*contour_bezier_simple.txt $contour_simpl
    ...
    mv $1/*fill_simple.eps $eps_simpl
fi
